...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-01-15-basic-post.md')).writeAsStringSync('''
---
title: Basic Post
date: 2024-01-15
---
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-02-20-tech-post.md')).writeAsStringSync('''
---
title: Tech Post
date: 2024-02-20
...
''');
      ...
      expect(techPost.config['categories'], equals(['technology', 'programming', 'web']));
      
      // Should use first category "technology"
      expect(techPost.link(), equals('technology/2024/02/20/tech-post.html'));
    });

    test('post with tags but no categories should use "posts" category', () async {
      // Create site structure
      await memoryFileSystem.directory(p.join(projectRoot, '_posts')).create(recursive: true);
      await memoryFileSystem.directory(p.join(projectRoot, '_layouts')).create(recursive: true);
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-03-10-tagged-post.md')).writeAsStringSync('''
---
title: Tagged Post
date: 2024-03-10
...
''');
      ...
      expect(taggedPost.config['tags'], equals(['dart', 'testing', 'development']));
  ...
  group('Built-in Permalink Structures', () {
    test('date format: :categories/:year/:month/:day/:title:output_ext', () async {
      // Create site structure
      await memoryFileSystem.directory(p.join(projectRoot, '_posts')).create(recursive: true);
      await memoryFileSystem.directory(p.join(projectRoot, '_layouts')).create(recursive: true);
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-05-25-date-format-test.md')).writeAsStringSync('''
---
...
''');
      ...
      expect(post.link(), equals('tutorials/2024/05/25/date-format-test.html'));
    });
...
''');
      ...
      // Create post
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-04-01-pretty-post.md')).writeAsStringSync('''
---
title: Pretty Post
date: 2024-04-01
categories: [blog]
...
''');
      ...
      expect(prettyPost.link(), equals('blog/2024/04/01/pretty-post/index.html'));
    });

    test('ordinal format: :categories/:year/:y_day/:title:output_ext', () async {
      // Create site structure
      await memoryFileSystem.directory(p.join(projectRoot, '_posts')).create(recursive: true);
      await memoryFileSystem.directory(p.join(projectRoot, '_layouts')).create(recursive: true);
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-03-01-ordinal-test.md')).writeAsStringSync('''
---
title: Ordinal Test
date: 2024-03-01
categories: [science]
...
''');
    ...
    test('weekdate format: :categories/:year/W:week/:short_day/:title:output_ext', () async {
      // Create site structure
      await memoryFileSystem.directory(p.join(projectRoot, '_posts')).create(recursive: true);
      await memoryFileSystem.directory(p.join(projectRoot, '_layouts')).create(recursive: true);
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-01-08-weekdate-test.md')).writeAsStringSync('''
---
title: Weekdate Test
date: 2024-01-08
categories: [weekly]
...
''');
      ...
      // Create post
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-07-15-none-format-test.md')).writeAsStringSync('''
---
...
''');
      ...
      // Create post
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-08-20-post-format-test.md')).writeAsStringSync('''
---
...
''');
      ...
      // Create post
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-05-15-custom-post.md')).writeAsStringSync('''
---
title: Custom Post
date: 2024-05-15
---
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-09-12-month-name-test.md')).writeAsStringSync('''
---
...
''');
      ...
      expect(post.link(), equals('archive/2024/September/month-name-test.html'));
    });
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-06-14-short-date-test.md')).writeAsStringSync('''
---
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-03-05-numeric-date-test.md')).writeAsStringSync('''
---
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-10-01-literal-path-test.md')).writeAsStringSync('''
---
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-11-20-token-override-test.md')).writeAsStringSync('''
---
...
''');
      ...
      expect(post.config['permalink'], equals('/custom/:categories/:short_year/:title/'));
      
      // Should process the tokens in the custom permalink
      // :short_year for 2024 is "24"
      expect(post.link(), equals('custom/special/24/token-override-test/index.html'));
    });
  });
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-12-01-special-chars.md')).writeAsStringSync('''
---
...
''');
      ...
      final post = posts.first;
      expect(post.config['title'], equals('Special & Characters! @#\$%^&*()_+ Post'));
      
      // Special characters should be normalized/sanitized in the URL
      expect(post.link(), equals('posts/2024/12/01/special-characters-post.html'));
    });
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-12-15-empty-categories.md')).writeAsStringSync('''
---
...
''');
      ...
      expect(post.link(), equals('posts/2024/12/15/empty-categories-test.html'));
    });
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-12-25-slug-test.md')).writeAsStringSync('''
---
...
''');
      ...
      final post = posts.first;
      expect(post.config['title'], equals('This is a Very Long Title That Should Be Overridden'));
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-01-01-old-post.md')).writeAsStringSync('''
---
title: Old Post
date: 2024-01-01
---
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-12-31-new-post.md')).writeAsStringSync('''
---
title: New Post
date: 2024-12-31
---
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-06-15-middle-post.md')).writeAsStringSync('''
---
title: Middle Post
date: 2024-06-15
---
...
''');
      ...
      for (int i = 0; i < posts.length - 1; i++) {
        expect(posts[i].date.isAfter(posts[i + 1].date) || 
...
''');
      ...
      memoryFileSystem.file(p.join(projectRoot, '_posts', '2024-10-01-metadata-test.md')).writeAsStringSync('''
---
...
''');
      ...
      expect(metadataPost.config['categories'], equals(['tech', 'programming']));
      expect(metadataPost.config['tags'], equals(['dart', 'testing', 'metadata']));
      expect(metadataPost.config['excerpt'], equals('This is a test excerpt for the post.'));
