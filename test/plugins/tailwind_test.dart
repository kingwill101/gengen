  ...
  group('TailwindPlugin', () {
    test('should have correct metadata', () {
      ...
      expect(
        ...
        equals('Compiles Tailwind CSS files in GenGen'),
      );
    });
    ...
    test('should skip compilation when input file does not exist', () async {
      ...
      await memoryFileSystem
          .directory(p.join(projectRoot, 'assets', 'css'))
...
''');
    ...
    test(
      'should skip compilation when tailwind executable does not exist',
      () async {
...
''');
        ...
        memoryFileSystem
            .file(p.join(projectRoot, 'assets', 'css', 'tailwind.css'))
            .writeAsStringSync('''
@tailwind base;
@tailwind components;
@tailwind utilities;
...
''');
      ...
      memoryFileSystem
          .file(p.join(projectRoot, 'tailwindcss'))
